...
// Queue<string> normal = new Queue<string>(new []{"Armen", "Rodion"});
//
// void Test(Queue<string> Vip, Queue<string> Normal)
// {
//     while (Vip.Count != 0 || Normal.Count != 0)
//     {
//         if (Vip.Count > 0)
//         {
//             var client = Vip.Dequeue();
//             Console.WriteLine($"Vip client:{client}");
//         }
//         else if (Normal.Count > 0)
//         {
//             var client2 = Normal.Dequeue();
//             Console.WriteLine($"Normal client:{client2}");
//
//         }
//     }
// }
